<div>
    <div class="mx-auto h-screen w-full bg-gradient-to-r from-blue-200 to-cyan-200 px-4 py-10 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
                <div>
                    ...
                    <div class="mt-7 grid w-full gap-3 sm:inline-flex">
                        ...
                        <a class="inline-flex items-center justify-center gap-x-2 rounded-lg border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-800 shadow-sm hover:bg-gray-50 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-slate-900 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/contact">
                            Contact sales team
                        </a>
                    </div>
                ...
                <div class="relative ms-4">
                    ...
                    <div class="absolute bottom-0 start-0">
                        <svg class="ms-auto h-auto w-2/3 text-white dark:text-slate-900" width="630"

<div>
    <div class="relative mx-auto h-screen w-full px-4 py-10 sm:px-6 lg:px-8">
        <!-- Fondo completo con la imagen del banner -->
        <div class="absolute inset-0 z-0">
            <img class="h-full w-full object-cover" src="https://4kwallpapers.com/images/walls/thumbs_3t/13355.jpg"
            ...
            <div class="grid gap-4 md:grid-cols-2 md:items-center md:gap-8 xl:gap-20">
                <div>
                    {{-- <h1 class="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight">
                        Start your journey with <span class="text-blue-300">Ecommerce</span></h1>
                    <p class="mt-3 text-lg text-gray-200">Purchase wide varieties of electronics products
                        like Smartphones, Laptops, Smartwatches, Television and many more.</p>

                    <!-- Buttons -->
                    <div class="mt-7 grid w-full gap-3 sm:inline-flex">
                        <a class="inline-flex items-center justify-center gap-x-2 rounded-lg border border-transparent bg-blue-600 px-4 py-3 text-sm font-semibold text-white hover:bg-blue-700 disabled:pointer-events-none disabled:opacity-50"
                            href="/register">
                            Get started
                        ...
                        <a class="inline-flex items-center justify-center gap-x-2 rounded-lg border border-white/30 bg-white/10 px-4 py-3 text-sm font-medium text-white backdrop-blur-sm hover:bg-white/20"
                            href="/contact">
                            Contact sales team
                        </a>
                    </div> --}}
                    ...
                    {{-- <div class="mt-6 grid grid-cols-2 gap-x-5 lg:mt-10">
                        ...
                        <div class="py-5">
                            <div class="flex space-x-1">
                                <svg class="h-4 w-4 text-yellow-300" width="51" height="51" viewBox="0 0 51 51"
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="h-auto w-16 text-white" width="80" height="27" viewBox="0 0 80 27"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div class="py-5">
                            ...
                            <div class="mt-5">
                                <!-- Star -->
                                <svg class="h-auto w-16 text-white" width="110" height="28"
                ...
                {{-- <div class="relative ms-4">
                    ...
                    <div
                        class="absolute inset-0 -z-[1] -mb-4 -ms-4 me-4 mt-4 h-full w-full rounded-md bg-gradient-to-tr from-gray-200 via-white/0 to-white/0 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0 lg:-mb-6 lg:-ms-6 lg:me-6 lg:mt-6">
                    </div>

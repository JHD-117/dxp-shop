    ...
    <div class="mx-auto w-full max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:pt-20">
        ...
        <div class="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div class="col-span-2">
                ...
                <form>
                    <div
                        class="mt-4 flex flex-col items-center gap-2 rounded-lg bg-white p-2 dark:bg-gray-800 sm:flex-row sm:gap-3">
                        <div class="w-full">
                            <input type="text" id="hero-input" name="hero-input"
                                class="block w-full rounded-lg border-transparent px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-transparent dark:bg-slate-900 dark:text-gray-400 dark:focus:ring-gray-600"
                                placeholder="Enter your email">
                        </div>
                        <a class="inline-flex w-full items-center justify-center gap-x-2 whitespace-nowrap rounded-lg border border-transparent bg-blue-600 p-3 text-sm font-semibold text-white hover:bg-blue-700 disabled:pointer-events-none disabled:opacity-50 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 sm:w-auto"
                            href="#">
                            Subscribe
                        </a>
                    </div>
        ...
        <div class="mt-5 grid gap-y-2 sm:mt-12 sm:flex sm:items-center sm:justify-between sm:gap-y-0">
            ...
            <!-- Social Brands -->
            <div>
                <a class="inline-flex h-10 w-10 items-center justify-center gap-x-2 rounded-lg border border-transparent text-sm font-semibold text-white hover:bg-white/10 focus:outline-none focus:ring-1 focus:ring-gray-600 disabled:pointer-events-none disabled:opacity-50"
                    href="#">

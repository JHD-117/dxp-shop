                        ...
                        <nav aria-label="page-navigation">
                            <ul class="list-style-none flex">
                                <li class="page-item disabled">
                                    <a href="#"
                                        class="pointer-events-none relative mr-3 block rounded-md px-3 py-1.5 text-base text-gray-700 transition-all duration-300 hover:bg-blue-600 hover:text-gray-100 dark:text-gray-400">Previous
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a href="#"
                                        class="relative mr-3 block rounded-md bg-blue-400 px-3 py-1.5 text-base text-gray-100 transition-all duration-300 hover:bg-blue-200 hover:text-blue-700 dark:hover:bg-gray-700 dark:hover:text-gray-400">1
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a href="#"
                                        class="relative mr-3 block rounded-md px-3 py-1.5 text-base text-gray-700 transition-all duration-300 hover:bg-blue-100 dark:text-gray-400 dark:hover:bg-gray-700">2
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a href="#"
                                        class="relative mr-3 block rounded-md px-3 py-1.5 text-base text-gray-700 transition-all duration-300 hover:bg-blue-100 dark:text-gray-400 dark:hover:bg-gray-700">3
                                    </a>
                                </li>
                                <li class="page-item">
                                    <a href="#"
                                        class="relative block rounded-md px-3 py-1.5 text-base text-gray-700 transition-all duration-300 hover:bg-blue-100 dark:text-gray-400 dark:hover:bg-gray-700">Next
                                    </a>
                                </li>
                            </ul>
                        </nav>
